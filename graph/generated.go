...
type ComplexityRoot struct {
	Query struct {
		Test               func(childComplexity int, filter *model.TestFilter, a int, b int) int
...
type QueryResolver interface {
	Test(ctx context.Context, filter *model.TestFilter, a int, b int) (int, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.test":
		...
		return e.complexity.Query.Test(childComplexity, args["filter"].(*model.TestFilter), args["a"].(int), args["b"].(int)), true
...
func (e *executableSchema) Exec(ctx context.Context) graphql.ResponseHandler {
	...
	inputUnmarshalMap := graphql.BuildUnmarshalerMap(
		...
		ec.unmarshalInputTestSubFilter,
	)
	first := true
...
func (ec *executionContext) field_Query_test_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 *model.TestFilter
	if tmp, ok := rawArgs["filter"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("filter"))
		arg0, err = ec.unmarshalOTestFilter2ᚖexampleᚋgraphᚋmodelᚐTestFilter(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Query_test(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Query().Test(rctx, fc.Args["filter"].(*model.TestFilter), fc.Args["a"].(int), fc.Args["b"].(int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputTestFilter(ctx context.Context, obj interface{}) (model.TestFilter, error) {
	var it model.TestFilter
	...
	for _, k := range fieldsInOrder {
		...
		case "a":
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("a"))
			data, err := ec.unmarshalOTestSubFilter2ᚖexampleᚋgraphᚋmodelᚐTestSubFilter(ctx, v)
			if err != nil {
				return it, err
			}
			it.A = data
...
func (ec *executionContext) unmarshalInputTestSubFilter(ctx context.Context, obj interface{}) (model.TestSubFilter, error) {
	var it model.TestSubFilter
	asMap := map[string]interface{}{}
	for k, v := range obj.(map[string]interface{}) {
		asMap[k] = v
	}
...
func (ec *executionContext) unmarshalOTestFilter2ᚖexampleᚋgraphᚋmodelᚐTestFilter(ctx context.Context, v interface{}) (*model.TestFilter, error) {
	if v == nil {
		return nil, nil
	}
...
func (ec *executionContext) unmarshalOTestSubFilter2ᚖexampleᚋgraphᚋmodelᚐTestSubFilter(ctx context.Context, v interface{}) (*model.TestSubFilter, error) {
	if v == nil {
		return nil, nil
	}
	res, err := ec.unmarshalInputTestSubFilter(ctx, v)
	return &res, graphql.ErrorOnPath(ctx, err)
}
